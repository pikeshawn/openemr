...
<head>
    ...
    <script type="text/javascript"
            src="<?php echo $web_root; ?>/library/textformat.js?v=<?php echo $v_js_includes; ?>"></script>
    <script type="text/javascript"
            src="<?php echo $web_root; ?>/library/dialog.js?v=<?php echo $v_js_includes; ?>"></script>
    <script type="text/javascript"
            src="<?php echo $GLOBALS['assets_static_relative']; ?>/jquery/dist/jquery.min.js"></script>
    <script type="text/javascript"
            src="<?php echo $web_root; ?>/library/js/common.js?v=<?php echo $v_js_includes; ?>"></script>
    <script type="text/javascript"
...
<!--    <script type="text/javascript" src="--><?php //echo $web_root; ?><!--/backline/backline_patient_portal.js"></script>-->
    <script type="text/javascript" src="https://openemr.staging.drfirst.com/backline/backline_patient_portal.js"></script>
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                        ...
                        <table cellspacing=0 cellpadding=0>
                            ...
                            <tr>
                                <td width='650px'>
                                    ...
                                    ?>
                                    <br/>
                                    <div style='margin-left:3em; margin-right:3em; padding:1em; border:1px solid blue;'
                                         class='text'>
                                        <div id="ccr_report">
                                            <form name='ccr_form' id='ccr_form' method='post'
                                                  action='../ccr/createCCR.php?portal_auth=1'>
                                                <span class='text'><b><?php echo xlt('Continuity of Care Record (CCR)'); ?></b></span>&nbsp;&nbsp;
                                                <br/>
                                                <span class='text'>(<?php echo xlt('Pop ups need to be enabled to see these reports'); ?>
                                                    )</span>
                                                <br/>
                                                <br/>
             ...
             <input type="button" class="generateCCR_download_p" value="<?php echo xla('Download'); ?>"/>
                                                    ...
                                                    <?php if ($GLOBALS['phimail_enable'] == true && $GLOBALS['phimail_ccr_enable'] == true) { ?>
                                                        <input type="button" class="viewCCR_send_dialog"
             ...
             <input type="button" class="viewCCD_download" value="<?php echo xla('Download'); ?>"/>
                                                    ...
                                                    <?php if ($GLOBALS['phimail_enable'] == true && $GLOBALS['phimail_ccd_enable'] == true) { ?>
                                                        <input type="button" class="viewCCD_send_dialog"
                                                               value="<?php echo xla('Transmit'); ?>"/>
                                                        <br>
...
<div id="portal-buttons-bottom"> <!-- buttons bottom div -->
    <input type="button" style="text-align: right;" value="<?php echo xla('Log Out'); ?>"
