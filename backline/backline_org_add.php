...
<body class="body_top">
<table><tr><td>
<span class="title"><?php xl('Add Backline Organization','e'); ?></span>&nbsp;</td>
<td>
...
<tr>
<td style="width:150px;"><span class="text"><?php xl('Name','e'); ?>: </span></td><td  style="width:220px;"><input type=entry name=rumple style="width:120px;"> <span class="mandatory">&nbsp;*</span></td>
<td style="width:150px;"><span class="text"><?php xl('Backline ID','e'); ?>: </span></td><td style="width:250px;"><input type="entry" style="width:120px;" name=stiltskin><span class="mandatory">&nbsp;*</span></td>
</tr>
<tr>
